...
namespace Foodie.Data.Migrations
{
    ...
    [Migration("20200201213214_DayDataUpdateMigration")]
    partial class DayDataUpdateMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foodie.Models.DayData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Foodie.Models.Ingriedient", b =>
                {
                    b.HasOne("Foodie.Models.Meal", "Meal")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Foodie.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
